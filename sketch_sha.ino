#define BLYNK_TEMPLATE_ID "TMPL3NZiL4sl5"
#define BLYNK_TEMPLATE_NAME "smarthome appliance control"
#define BLYNK_AUTH_TOKEN "4FI_K7vqCj9rdNCMk6PIejBC4Xyyi2-L"
...
char auth[] = "4FI_K7vqCj9rdNCMk6PIejBC4Xyyi2-L";//Enter your Auth token
...
void gassensor() {
  ...
  if (value <= 55) {
    ...
    Blynk.logEvent("gas_alert","smoke Leakage Detected");
